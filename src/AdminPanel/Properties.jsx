...
const Properties = ({ setSelectedTab, setId }) => {
  ...
  const handleAddNeighbourhood = () => {
    setNeighbourhoods([
      ...neighbourhoods,
      {
        type: "",
        Transition: [
          { TypeOfType: "", value: [{ landMark: "", distance: "", time: "" }] },
        ], // Properly initialize Transition
      },
    ]);
  };
  ...
  const handleAddValue = (neighbourhoodIndex, transitionIndex) => {
    const updatedNeighbourhoods = [...neighbourhoods];
    updatedNeighbourhoods[neighbourhoodIndex].Transition[
      transitionIndex
    ].value.push({
      landMark: "",
      distance: "",
  ...
  const handleTransitionValueChange = (
    ...
    const updatedNeighbourhoods = [...neighbourhoods];
    const transition =
      updatedNeighbourhoods[neighbourhoodIndex]?.Transition[transitionIndex];
  ...
  const handleRemoveTransition = (neighbourhoodIndex, transitionIndex) => {
    const updatedNeighbourhoods = [...neighbourhoods];
    updatedNeighbourhoods[neighbourhoodIndex].Transition =
      updatedNeighbourhoods[neighbourhoodIndex].Transition.filter(
  ...
  const handleRemoveValue = (
    ...
    updatedNeighbourhoods[neighbourhoodIndex].Transition[
      transitionIndex
    ].value = updatedNeighbourhoods[neighbourhoodIndex].Transition[
      transitionIndex
  ...
  const handlePost = async (values) => {
    ...
    try {
      const response = await axios.post(
        baseurl + "/api/properties/cretePropeties",
        postdata
      );
  ...
  const handlePut = async (values) => {
    ...
    try {
      const response = await axios.put(
        `${baseurl}/api/properties/updatePropeties/${editingProperties._id}`,
        postdata
      );
      console.log(response.data);
  ...
  const columns = [
...

    {
      ...
      render: (_, record) => (
        <>
          <Button style={{ width: "115px" }} onClick={() => handleEdit(record)}>
            Update
          </Button>
          <br></br>
          <br></br>
          <Button
            onClick={() => handleCardClick(record?._id, "properties-details")}
          >
            View Details
          </Button>
        </>
      ...
      >
        <Form form={form} layout="vertical" onFinish={handleSubmit}>
          <Form.Item
            ...
            rules={[
              { required: true, message: "Please Input the Properties Name!" },
            ]}
          >
            <Input />
          </Form.Item>
  ...
  />
          ...
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: "Please Input the Properties Floor Plan!",
              },
            ]}
          >
            <Input
          ...
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: "Please select the property category!",
              },
            ]}
          >
          ...
          <Form.Item
            ...
            rules={[
              { required: true, message: "Please select the property status!" },
            ]}
          >
          ...
          <Form.Item
            ...
            rules={[
              { required: true, message: "Please input the property age!" },
            ]}
          >
            <InputNumber
            ...
            >
              ...
              >
                <Input
                  value={floor.bhk}
                  onChange={(e) =>
                    handleFloorTypeChange(index, "bhk", e.target.value)
                  }
              ...
              >
                <Input
                  value={floor.Area}
                  onChange={(e) =>
                    handleFloorTypeChange(index, "Area", e.target.value)
                  }
              ...
              >
                <InputNumber
                  value={floor.price}
                  onChange={(value) =>
                    handleFloorTypeChange(index, "price", value)
                  }
          ...
          {neighbourhoods.map((neighbourhood, neighbourhoodIndex) => (
            <div key={neighbourhoodIndex} style={{ marginBottom: "20px" }}>
              ...
              {neighbourhood.Transition.map((transition, transitionIndex) => (
                ...
                >
                  ...
                  <Button
                    type="dashed"
                    onClick={() =>
                      handleAddValue(neighbourhoodIndex, transitionIndex)
                    }
                    icon={<PlusOutlined />}
                  >
                    Add Value
              ...
              <Button
                type="dashed"
                onClick={() => handleAddTransition(neighbourhoodIndex)}
                icon={<PlusOutlined />}
              >
                Add Transition
              </Button>
              ...
              <Button
                type="link"
                onClick={() => handleRemoveNeighbourhood(neighbourhoodIndex)}
                icon={<MinusCircleOutlined />}
              >
          ...
          {overviews.map((overview, index) => (
            <div key={index} style={{ marginBottom: "20px" }}>
              ...
              >
                <Select
                  value={
                    typeof overview.name === "object"
                      ? overview.name._id
                      : overview.name
                  } // Handle object or ID
                  onChange={(value) =>
                    handleOverviewChange(index, "name", value)
                  }
              ...
              <Form.Item
                label="Page Type"
                rules={[
                  { required: true, message: "Please select a page type" },
                ]}
              >
                <Select
                  value={overview.pageType}
                  onChange={(value) =>
                    handleOverviewChange(index, "pageType", value)
                  }
              ...
              <Form.Item
                label="Input Type"
                rules={[
                  { required: true, message: "Please select the input type" },
                ]}
              >
                <Select
                  value={overview.inputType}
                  onChange={(value) =>
                    handleOverviewChange(index, "inputType", value)
                  }
                  ...
                  {overview.category && (
                    ...
                    >
                      <Select
                        value={overview.value || ""}
                        onChange={(value) =>
                          handleOverviewChange(index, "value", value)
                        }
                        placeholder={`Select a ${overview.category}`}
                        loading={dropdownLoading}
                        notFoundContent={
                          dropdownLoading ? "loading" : "No options"
                        }
                      >
          ...
          {tags.map((tag, index) => (
            ...
            >
              <Form.Item
                ...
                required
                rules={[
                  { required: true, message: "Please input the tag value!" },
                ]}
              >
                <Input
            ...
            <>
              {cross ? (
                <>
                  ...
                  />
                  <img
                    src={`${baseurl}${record1?.camelliasImage}`}
                    alt=""
